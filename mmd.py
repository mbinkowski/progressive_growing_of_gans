...
def mmd2(K, biased=False, m=None, n=None):
    K_XX, K_XY, K_YY, const_diagonal = K
    return _mmd2(K_XX, K_XY, K_YY, const_diagonal, biased, m=m, n=n) # numerics checked at _mmd2 return
    

def _mmd2(K_XX, K_XY, K_YY, const_diagonal=False, biased=False, m=None, n=None):
    if m is None:
        m = K_XX.get_shape()[0]
    if n is None:
        n = K_YY.get_shape()[0]
